...
class MyVertex  : public vcg::Vertex< MyUsedTypes, vcg::vertex::Coord3d, vcg::vertex::Qualityd, vcg::vertex::Normal3d, vcg::vertex::Color4b, vcg::vertex::VFAdj, vcg::vertex::VEAdj, vcg::vertex::BitFlags  >{};
